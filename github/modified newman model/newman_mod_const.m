...
C1=4.65e-10; %coeficiente de fit
C2=2.8; %coeficiente de fit
...
if  c >= 0.015 && u == 0 %condicao de spike load
    S = Sover;
    u = 1;
    flag1=0; %flag para iniciar nova discretizacao de zona plastica - ALTERADO PARA CONSTANTE
...
%[Sop] = newman_sop_const(s_0,Smax,alpha,R); %funcao de Sop pelos polinomios de newman
...
% figure(2)
% plot(crack_length*1000,da_dN_regist)
% hold on

% figure(3)
% plot(coord*1000,def_registro)
% hold on
end